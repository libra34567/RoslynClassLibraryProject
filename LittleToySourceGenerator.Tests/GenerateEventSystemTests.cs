...
";
    ...
    [TestMethod]
    public void ComponentDirtyEventWithDifferentNamespaces()
    {
        string source = @"
using Plugins.basegame.Events;

namespace Test1.ChildNamespace
{
    [Plugins.basegame.Events.ComponentDirtyEvent]
    public partial struct Position3Data : Unity.Entities.IComponentData
    {
...
namespace Test2.InnerNamespace
{
    using Test1.ChildNamespace;
...
namespace Test1.ChildNamespace
{
    ...
    public partial class Position3EventSystem : SystemBase
    {
        ...
        protected override void OnCreate()
        {
            ...
            _entityWithTransformViewAndPosition3DataQuery = GetEntityQuery(new EntityQueryDesc
            {
                All = new []
                {
                    ComponentType.ReadWrite<Test2.InnerNamespace.TransformView>(),
                    ComponentType.ReadOnly<Position3Data>(),
                }
            });
            _entityWithTransformViewAndPosition3DataQuery.SetChangedVersionFilter(ComponentType.ReadOnly<Position3Data>());
        ...
        {
            _position3DataROComponentTypeHandle.Update(this);
            var notifyTransformViewPosition3DataDirtyJob = new NotifyPosition3DataDirtyJob<Test2.InnerNamespace.TransformView>
            {
                EntityManager = this.EntityManager,
                DataTypeHandle = _position3DataROComponentTypeHandle,
                ListenerTypeHandle = EntityManager.GetComponentTypeHandle<Test2.InnerNamespace.TransformView>(false),
            };
            CompleteDependency();
            JobEntityBatchExtensions.RunWithoutJobs(ref notifyTransformViewPosition3DataDirtyJob, _entityWithTransformViewAndPosition3DataQuery);
    ...
    private struct NotifyPosition3DataDirtyJob<T> : IJobEntityBatch where T : class, Test1.ChildNamespace.IPosition3Listener
    {
        public EntityManager EntityManager;
        [ReadOnly]
        public ComponentTypeHandle<Position3Data> DataTypeHandle;
...
";
    ...
    [TestMethod]
    public void ComponentAddedEventWithDifferentNamespaces()
    {
        string source = @"
using Plugins.basegame.Events;
...
namespace Test1.ChildNamespace
{
    ...
    public partial class Position3EventSystem : SystemBase
    {
        ...
        {
            _addedComponentArrayDataROComponentTypeHandle.Update(this);
            var notifyTransformViewAddPosition3DataJob = new NotifyAddPosition3DataJob<Test2.InnerNamespace.TransformView>
            {
                EntityManager = this.EntityManager,
                DataTypeHandle = _addedComponentArrayDataROComponentTypeHandle,
                ListenerTypeHandle = EntityManager.GetComponentTypeHandle<Test2.InnerNamespace.TransformView>(false),
    ...
    private struct NotifyAddPosition3DataJob<T> : IJobEntityBatch where T : class, Test1.ChildNamespace.IPosition3AddedListener
    {
        public EntityManager EntityManager;
        [ReadOnly]
        public ComponentTypeHandle<AddedComponentArrayData> DataTypeHandle;
...
";
    ...
    [TestMethod]
    public void ComponentRemovedEventWithDifferentNamespaces()
    {
        string source = @"
using Plugins.basegame.Events;
...
namespace Test1.ChildNamespace
{
    ...
    public partial class Position3EventSystem : SystemBase
    {
        ...
        {
            _removedComponentArrayDataROComponentTypeHandle.Update(this);
            var notifyTransformViewRemovePosition3DataJob = new NotifyRemovePosition3DataJob<Test2.InnerNamespace.TransformView>
            {
                EntityManager = this.EntityManager,
                DataTypeHandle = _removedComponentArrayDataROComponentTypeHandle,
                ListenerTypeHandle = EntityManager.GetComponentTypeHandle<Test2.InnerNamespace.TransformView>(false),
    ...
    private struct NotifyRemovePosition3DataJob<T> : IJobEntityBatch where T : class, Test1.ChildNamespace.IPosition3RemovedListener
    {
        public EntityManager EntityManager;
        [ReadOnly]
        public ComponentTypeHandle<RemovedComponentArrayData> DataTypeHandle;
...
";
    ...
    [TestMethod]
    public void ComponentDirtyEventProperties()
    {
        string source = @"
using Plugins.basegame.Events;
...
public partial struct Position3Data : Unity.Entities.IComponentData
{
    [MarkDirty] public Unity.Mathematics.float3 Value { get; set; }
}
...
";
    ...
    [TestMethod]
    public void ComponentAddedEventOnProperties()
    {
        string source = @"
using Plugins.basegame.Events;
...
";
    ...
    [TestMethod]
    public void ComponentRemovedEventWithProperties()
    {
        string source = @"
using Plugins.basegame.Events;
