...
";
    ...
    [TestMethod]
    public void PrefabAccountForNamespaces()
    {
        string source = @"
using UnityEngine;
using Zenject;
...
public partial class SomeNewInstaller : MonoInstaller
{
    ...
    [AssetsOnly]
    [SerializeField]
    private My.InternalNamespace.ZenGenSomeSystemInNewInstaller zenGenSomeSystemInNewInstaller;
    ...
    private void InstallPrefabs()
    {
        Container.BindFactory<My.InternalNamespace.ZenGenSomeSystemInNewInstaller, My.InternalNamespace.ZenGenSomeSystemInNewInstaller.Factory>().FromComponentInNewPrefab(zenGenSomeSystemInNewInstaller);
    }
...
public partial class ZenGenSomeSystemInNewInstaller
{
    ...
    public class Factory : PlaceholderFactory<My.InternalNamespace.ZenGenSomeSystemInNewInstaller>
    {
    }
}
}
";
    ...
    [TestMethod]
    public void PrefabAndInstallerInDifferentNamespaces()
    {
        string source = @"
using UnityEngine;
using Zenject;
...
namespace test.something
{
    public partial class SomeNewInstaller {}
}
